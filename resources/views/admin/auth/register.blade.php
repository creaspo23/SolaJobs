                    ...
                    <div class="w-full px-4 lg:w-4/12">
                        <div
                            ...
                            <div class="px-6 py-6 mb-0 rounded-t">
                                <div class="mb-3 text-center">
                                    ...
                                    <div class="inline-block px-4 py-2 mr-4 text-sm text-3xl font-bold leading-relaxed text-white whitespace-no-wrap bg-purple-600 rounded-full shadow-lg"
                                        ...
                                        <span class="text-4xl uppercase ">re</span>gi<span
                                            class="text-4xl uppercase ">st</span>er
                                    </div>
                            ...
                            <div class="flex-auto px-4 py-10 pt-0 shadow-xl lg:px-10">
                                ...
                                <form method="POST" action="/dashbord/register">
                                    @csrf
                                    <div class="relative w-full mb-3">
                                        <label class="block mb-2 text-xs font-bold text-gray-700 uppercase"
                                            for="name">{{ __('User_Name') }}</label>
                                    ...
                                    <div class="relative w-full mb-3">
                                        <label class="block mb-2 text-xs font-bold text-gray-700 uppercase"
                                            for="password_confirmation">{{ __('Password_confirmation') }}
                                        </label>
                                ...
                                <div class="flex flex-wrap mt-6">
                                    ...
                                    <div class="w-1/2 mb-2 font-bold text-center gray-700 text- text-s ">
                                        <a href="{{ route('auth.login') }}" class="text-gray-900"><small>All ready
                                                have
                                                account?</small></a>
                                    </div>
                                </div>
