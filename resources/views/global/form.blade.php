...
<label for="jobTitle" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">job -
    title</label>
<input id="jobTitle" type="text" name="jobTitle" placeholder="web -dev" autocomplete="jobTitle"
    class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner"
    required />

<label for="jobDescription" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">job -
    description</label>
...
<input id="password-confirm" type="boolean" name="gender" placeholder="male" autocomplete="gender"
    class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner"
    required />
