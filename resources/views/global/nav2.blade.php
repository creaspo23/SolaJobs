            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                <li class="items-center">
                    <a class="text-pink-500 hover:text-pink-600 text-xs uppercase py-3 font-bold block"
                        href="{{ route('pages.index') }}"><i class="fas fa-tv opacity-75 mr-2 text-sm"></i>
                        Home</a>
                </li>
                <li class="items-center">
                ...
                <li class="items-center">
                    <a class="text-gray-800 hover:text-gray-600 text-xs uppercase py-3 font-bold block" href="/home"><i
                            class="fas fa-user-circle text-gray-500 mr-2 text-sm"></i>
                        Visit Website</a>
                </li>
                <li class="items-center">
