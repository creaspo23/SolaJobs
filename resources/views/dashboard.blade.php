...
<body class="text-gray-800 antialiased">
    ...
    <div id="root">
      ...
      <div class="relative md:ml-64 bg-gray-100" style="background-image: url({{ asset ('assets/img/dashboard-img.webp')}}); background-repeat: no-repeat;">
        <nav
        ...
        <!-- Header -->
        <div class="relative  md:pt-32 pb-32 pt-12" style="height: 100%;
position: relative;
top: 60%;">
